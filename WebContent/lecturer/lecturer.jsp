...
<body>
	...
	<form id="lectureForm" action="lecture" method="post">
		<p>
		<c:choose>
			<c:when test="${!running}">
				<input id="runSchedulerButton" type="submit" name="enrollment" value="Modify Lectures" />
			</c:when>
			<c:otherwise>
